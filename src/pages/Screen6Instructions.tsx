  ...
  return (
    <Layout title="Как отправить" subtitle="Выберите удобный способ" step={6} onBack={() => navigate('/consent')}>
      ...
      <div className="reminder-section">
        ...
        <p className="hint-text" style={{ marginTop: '8px', fontSize: '0.85rem' }}>
          30 дней по ст. 12 ФЗ № 59-ФЗ считаются со дня регистрации обращения госорганом
          (обязаны зарегистрировать в течение 3 дней с момента поступления — при почтовой
          отправке это может быть позже дня отправки), а не с даты, указанной здесь. Срок также
          законно может быть продлён ещё на 30 дней с уведомлением вас об этом — если ответа
          нет на 31-й день, не обязательно значит нарушение, но стоит уточнить, не продлевали ли срок.
        </p>
      </div>
