...
const FEDERAL_FALLBACK: Record<string, Benefit[]> = {
  ...
  'employment/ussr_deposits': [
    { id: -7, benefit_name: 'Компенсация по вкладам СССР', description: 'Сейчас выплачивается только частичная предварительная компенсация (2–3-кратный номинал остатка на 20.06.1991, по возрастному коэффициенту, до ≈6 000 ₽) — полная компенсация в «долговых рублях» по ФЗ № 73-ФЗ неоднократно переносилась, срок сейчас — с 01.01.2027', legal_basis: 'ФЗ № 73-ФЗ от 10.05.1995, Постановление Правительства РФ № 1092 от 25.12.2009', is_federal: true },
  ],
  'health/disability': [
