...
const ESCALATION_TARGETS: Record<string, string> = {
  ...
  'Финансовый уполномоченный': 'Служба финансового уполномоченного (finombudsman.ru) — обязателен для споров со страховыми до суда',
        ...
        <div className="takt-start">
          ...
          {esc.takt === 3 && (
            <>
              ...
              <div className="warning-banner">
                ⚠ Срок подачи иска — 3 месяца со дня, когда вы узнали о нарушении своих прав
                (ст. 219 КАС РФ). Пропуск срока без уважительной причины — основание для отказа
                в иске судом. Перед подачей рекомендуем проконсультироваться с юристом.
              </div>
            </>
          )}
          ...
          <div className="consent-box" style={{ marginTop: '16px' }}>
            ...
            {esc.takt === 3 && (
              <p className="consent-text">
                ...
                Мне известно о трёхмесячном сроке подачи иска по ст. 219 КАС РФ.
